...
$query_result = $taskDistribution->showtotalDistributedJob();
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i>Pending Job</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="#">Home</a></li>
              <li><i class="fa fa-laptop"></i><a href="#">Task Distribution</a></li>
              <li><i class="fa fa-laptop"></i>Pending Job</li>
            </ol>
          </div>
        </div>
