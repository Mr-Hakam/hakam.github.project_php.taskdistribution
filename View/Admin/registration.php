...
if(isset($_POST['btn'])){
    require_once '../../method/registration.php';
    $reg = new registration();
    $message = $reg->regOfficer($_POST);
}
...
<a href="#" class="logo">Hakam <span class="lite">Information Technology</span></a>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-laptop"></i><a href="#">Registration</a></li>
            </ol>
          </div>
        </div>
        ...
        <!-- Registration field start -->
        <div class="container">
            <div class="row">
                <div class="col-md-offset-2 col-md-8">
                    <h3 class="text-center text-success"><?php echo $message; ?></h3>
                    <div class="well" style="margin-top: 50px; padding: 80px;">
                        <h3 class="text-center text-success" style="padding-left: 100px;"><strong>Please Use Valid Email Address And Security Password</strong></h3>
