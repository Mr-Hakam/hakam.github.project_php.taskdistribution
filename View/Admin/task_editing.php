...
$load = new taskDistribution();

require_once '../../method/edit_task.php';
$edit=new edit_task();
$query_result=$edit->showTaskInfo($task_id);
$dataCollect = mysqli_fetch_assoc($query_result);
...
if(isset($_POST['btn'])){
   $edit->update_task($_POST); 
}

$query_result = $load->loadPersonName();
?>
<!DOCTYPE html>
<html lang="en">
...
<a href="#" class="logo">Hakam <span class="lite">Information Technology</span></a>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i>Task Editing</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="#">Home</a></li>
              <li><i class="fa fa-laptop"></i><a href="#">Task Distribution</a></li>
              <li><i class="fa fa-laptop"></i>Edit Task</li>
            </ol>
          </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-offset-2 col-md-8">
                    ...
                    <div class="well" style="margin-top: 50px; padding: 80px;">
                        <h3 class="text-center text-success" style="padding-left: 100px;"><strong>Distribute Task To A Specific Person.</strong></h3>
                        <form class="form-horizontal" action="" method="POST">
                            <div class="form-group">
                                <label class="control-label col-md-3">Topic:</label>
                                <div class="col-md-9">
                                    <input type="text" name="topic"  class="form-control" required="" value="<?php echo $dataCollect['topic'];?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">Sort Description:</label>
                                <div class="col-md-9">
                                <textarea class="form-control" rows="5" name="description" required="">
                                    <?php echo $dataCollect['description'];?>
                                </textarea>
                            </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Assign Person:</label>
                                    <div class="col-sm-9">
                                        <select class="form-control" name="name">
                                            <option value="-1">-Select Person-</option>
                                            <?php while ($rs = mysqli_fetch_assoc($query_result)) { ?>
                                            <option value="<?php echo $rs['id'];?>"><?php echo $rs['name'];?> -<small><?php echo $rs['designation'];?></small></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="file" name="file"  value="<?php echo $dataCollect['file'];?>">
                                </div>
                            </div>
