...
if(isset($_GET['delete'])){
    $id = $_GET['delete'];
    $message = $taskDistribution->delete_task_info($id);
}
...
$query_result = $taskDistribution->showPandingJobtoOther();
?>
<!DOCTYPE html>
<html lang="en">
...
<script>
      function checkDelete(){
          var check=confirm("Are you sure to delete this member information!!");
          if(check){
              return true;
          }else{
              return false;
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i>Pending To Other's</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="#">Home</a></li>
              <li><i class="fa fa-laptop"></i><a href="#">Task Distribution</a></li>
              <li><i class="fa fa-laptop"></i>Pending To Other's</li>
            </ol>
          </div>
        </div>
                    ...
                    <div class="well">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td><a href="task_editing.php?task_id=<?php echo $panding_Job_info['task_id'];?>" class="btn btn-success" title="Edit">
                                        <span class="glyphicon glyphicon-edit"></span>
                                    </a>
                                    <a href="?delete=<?php echo $panding_Job_info['task_id'];?>" class="btn btn-danger" title="Delete" onclick="return checkDelete();">
