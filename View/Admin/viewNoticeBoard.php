...
<a href="#" class="logo">Hakam <span class="lite">Information Technology</span></a>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i>View Notice Board</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="#">Home</a></li>
              <li><i class="fa fa-laptop"></i><a href="#">View</a></li>
              <li><i class="fa fa-laptop"></i>View Notice Board</li>
            </ol>
          </div>
        </div>
         ...
         <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <p><a class="btn btn-default" href="viewNoticePostDetails.php?notic_id=<?php echo$contentn['notic_id'];?>&&title=<?php echo$contentn['title'];?>" role="button">View details &raquo;</a></p>
                </div>
            </div>
        </div>
