...
if(isset($_POST['btn'])){
    ...
    $distribute = new taskDistribution();
    $message = $distribute->saveTaskDistribution($_POST);
}
...
<a href="#" class="logo">Hakam <span class="lite">Information Technology</span></a>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i>New Distribution</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="#">Home</a></li>
              <li><i class="fa fa-laptop"></i><a href="#">Task Distribution</a></li>
              <li><i class="fa fa-laptop"></i>New Distribution</li>
            </ol>
          </div>
        </div>
                    ...
                    <div class="well" style="margin-top: 50px; padding: 80px;">
                        ...
                        <form class="form-horizontal" action="" method="POST">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="topic" required="" class="form-control" required="">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" name="name">
                                            ...
                                            <option value="<?php echo $rs['name'];?>"><?php echo $rs['name'];?> -<small><?php echo $rs['designation'];?></small></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-offset-3 col-md-9">
                            <input type="submit" name="btn" class="btn btn-success btn-block" value="Distribute">
                        </div>
                    </div> 
                        </form>
                    </div>
