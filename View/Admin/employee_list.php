...
require_once '../../method/member.php';
$member = new member();


if(isset($_GET['delete'])){
    $id = $_GET['delete'];
    $message = $member->delete_member_info($id);
}
...
$query_result = $member->select_all_member_info();
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i>Employee List</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="#">Home</a></li>
              <li><i class="fa fa-laptop"></i><a href="#">Employee List</a></li>
            </ol>
          </div>
        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="well">
                        <table class="table table-hover">
                            ...
                            <?php while($member_info = mysqli_fetch_assoc($query_result)){?>
                            <tr>
                                ...
                                <td><?php echo $member_info['designation'];?></td>
                                <td>
                                    <a href="?delete=<?php echo $member_info['id'];?>" class="btn btn-danger" title="Delete" onclick="return checkDelete();">
