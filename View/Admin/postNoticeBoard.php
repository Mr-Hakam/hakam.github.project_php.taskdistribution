...
if(isset($_POST['btn'])){
    ...
    $postn = new postAndView();
    $message = $postn->save_Notice_Board_content($_POST);
...
<a href="#" class="logo">Hakam <span class="lite">Information Technology</span></a>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i>Post to Notice Board</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="#">Home</a></li>
              <li><i class="fa fa-laptop"></i><a href="#">Post</a></li>
              <li><i class="fa fa-laptop"></i>Post to Notice Board</li>
            </ol>
          </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="well">
                    <h3 class="text-center text-info"><strong>Post To <span style="color: sandybrown;"> Notice Board</span></strong></h3>
                    <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-3 col-md-offset-9">
                                <button type="submit" name="btn" class="btn btn-success btn-block">Post to Notice Board</button>
                            </div>
                        </div>
                    </form>
                </div>
