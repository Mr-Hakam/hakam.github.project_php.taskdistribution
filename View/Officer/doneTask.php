...
$query_result = $taskDistribution->showDoneJobEmployee();
?>
<!DOCTYPE HTML>
<html>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
									 <a href="../../index.html"> <h1>Done Task</h1> 
                            ...
                            <table class="table table-hover">
                                ...
                                <?php while ($panding_Job_info = mysqli_fetch_assoc($query_result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a <?php $_SESSION['process_id'] = $panding_Job_info['task_id']?>><input type="submit" name="btn" class="btn btn-success" value="Done"></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </table>
