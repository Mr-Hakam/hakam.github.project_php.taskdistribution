...
require_once '../../method/postAndView.php';
$viewn=new postAndView();
$query_result = $viewn->showNoticeBoardContent();
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
									 <a href="../../index.html"> <h1>Notice Board</h1> 
...
user_tag_config['ebound_header_tag']['mobile']['adsCode'] = '';
          ...
          <div class="container">
            <div class="row">
                <?php while($contentn = mysqli_fetch_assoc($query_result)) {?>
                <div class="col-md-12">
                    <h2><?php echo $contentn['title'];?> <small>-<?php echo $contentn['subtitle']?></small></h2>
                    <h4 class="text-danger"><?php echo $contentn['name'];?><small>-<?php echo $contentn['designation'];?></small></h4>
                    <p><?php echo substr($contentn['details'], 0,1000)?> ......</p>
                    <p><a class="btn btn-default" href="notic_view_details.php?notic_id=<?php echo$contentn['notic_id'];?>&&title=<?php echo$contentn['title'];?>" role="button">View details &raquo;</a></p>
                </div>
            </div>
        </div>
