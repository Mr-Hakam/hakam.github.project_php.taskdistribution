...
$view=new postAndView();
$query_result = $view->showCommonHomeContent();
?>
<!DOCTYPE HTML>
<html>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
									 <a href="../../index.html"> <h1>Common Home</h1> 
...
user_tag_config['ebound_header_tag']['mobile']['adsCode'] = '';
          ...
          <div class="clearfix">
            ...
            <div class="row">
                <?php while($content = mysqli_fetch_assoc($query_result)) {?>
                <div class="col-md-12">
                    <h2><?php echo $content['title'];?> <small>-<?php echo $content['subtitle']?></small></h2>
                    <h4 class="text-danger"><?php echo $content['name'];?><small>-<?php echo $content['designation'];?></small></h4>
                    <p><?php echo substr($content['details'], 0,1000)?> ......</p>
                    <p><a class="btn btn-default" href="viewCommonDetails.php?com_id=<?php echo$content['com_id'];?>&&title=<?php echo$content['title'];?>" role="button">View details &raquo;</a></p>
                </div>
            </div>
        </div>
