...
$query_result = $view->selectContentInfoById($com_id);
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <h2><?php echo $post_info['title'];?><small>-<?php echo $post_info['subtitle']?></small></h2>
                            <p class="text-danger">M.A Hakam<small>-(Admin)</small></p>
                            <hr/>
                            <p><?php echo $post_info['details'];?></p>
                            <a href="common_home_view.php"><button type="button" class="btn btn-success">Back</button></a>
                        </div>
                    </div>
                </div>
            </div>
