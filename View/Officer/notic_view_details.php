...
$query_result = $view->selectNoticeContentById($id);
$post_infon= mysqli_fetch_assoc($query_result);
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <h2><?php echo $post_infon['title'];?><small>-<?php echo $post_infon['subtitle']?></small></h2>
                            <p class="text-danger">M.A Hakam<small> -Admin</small></p>
                            <hr/>
                            <p><?php echo $post_infon['details'];?></p>
                            <a href="notice_view.php"><button type="button" class="btn btn-success">Back</button></a>
                        </div>
                    </div>
                </div>
            </div>
