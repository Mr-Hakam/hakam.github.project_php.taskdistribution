            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
									 <a href="../../index.html"> <h1>On Going Task</h1> 
                            ...
                            <table class="table table-hover">
                                ...
                                <?php while ($panding_Job_info = mysqli_fetch_assoc($query_result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a <?php $_SESSION['task_processing_id'] = $panding_Job_info['task_processing_id']?>><input type="submit" name="btn" class="btn btn-success" value="Done"></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </table>
