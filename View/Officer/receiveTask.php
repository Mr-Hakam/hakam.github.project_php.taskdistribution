...
if(isset($_POST['btn'])){
    ...
    require_once '../../method/task_Processing.php';
    $processing = new task_Processing();
    $processing->task_to_processing($_POST);
}
require_once '../../method/taskDistribution.php';
$taskDistribution = new taskDistribution();
$query_result = $taskDistribution->showNewJobemployee();
?>
<!DOCTYPE HTML>
<html>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
									 <a href="../../index.html"> <h1>Receive New Task</h1> 
...
<div class="copyrights">
    <div class="container">
                    ...
                    <div class="well">
                        <form class="form-horizontal" action="" method="POST">
                            <table class="table table-hover">
                                ...
                                <?php while ($panding_Job_info = mysqli_fetch_assoc($query_result)) { ?>
                                    <tr>
                                        <td><?php echo $panding_Job_info ['topic'];?></td>
                                        <td><?php echo $panding_Job_info ['description']; ?></td>
                                        <td><?php echo $panding_Job_info ['name']; ?></td>
                                        <td><?php echo $panding_Job_info ['designation']; ?></td>
                                        <td><?php echo $panding_Job_info ['file']; ?></td>
                                        <td>
                                            <a <?php $_SESSION['transfer_id'] = $panding_Job_info['task_id']?>><input type="submit" name="btn" class="btn btn-success" value="Take To Process"></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </table>
	 ...
	 <p>© 2018 hakam35-1218@diu.edu.bd <a href="" target="_blank">W3layouts</a> </p>
</div>	
...
<div class="sidebar-menu">
    <div style="background-color: #044; min-height: 800px;">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li><a href="#"><i class="fa fa-file-archive-o"></i><span>Task</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul>
                              <li><a href="receiveTask.php">New</a></li>
                              <li><a href="Ongoing_Task.php">On going</a></li>
                              <li><a href="doneTask.php">Done</a></li>		            
		          </ul>
		        </li>
		        ...
		        <li id="menu-academico" ><a href="#"><i class="fa fa-file-text"></i><span>Complaint</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul id="menu-academico-sub" >
		          	 <li id="menu-academico-boletim" ><a href="">Against Task/Application</a></li>
		            <li id="menu-academico-avaliacoes" ><a href="">Against Person</a></li>		           
		          </ul>
		        </li>
		        ...
		        <li><a href="#"><i class="fa fa-envelope"></i><span>Message</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         ...
		         <li><a href="#"><i class="fa fa-cog"></i><span>View</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         	 <ul id="menu-academico-sub" >
                                     <li id="menu-academico-avaliacoes" ><a href="common_home_view.php">Common Home</a></li>
                                     <li id="menu-academico-boletim" ><a href="notice_view.php">Notice Board</a></li>
		             </ul>
		         </li>
		      </ul>
		    </div>
