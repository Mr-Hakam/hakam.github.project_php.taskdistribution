      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
                <li><a class="" href="View/Admin/newTaskDistribution.php">New Distribution</a></li>
                <li><a class="" href="View/Admin/total_distribution.php">Total Distributed</a></li>
                <li><a class="" href="View/Admin/PendingJob_taskDistribution.php">Pending For Me</a></li>
                <li><a class="" href="View/Admin/pendingToOthers.php">Pending To Others</a></li>
                <li><a class="" href="View/Admin/done.php">Done</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;" class="">
            ...
            <ul class="sub">
                <li><a class="" href="View/Admin/salary.php">Salary</a></li>
                <li><a class="" href="View/Admin/Bonus.php">Bonus</a></li>
            </ul>
          </li>
          <li>
              <a class="" href="View/Admin/employee_list.php">
                          <i class="fa fa-list-alt"></i>
                          <span>Employee List</span>
                      </a>
          </li>
          <li>
              <a class="" href="View/Admin/registration.php">
          ...
          <li class="sub-menu">
              <a href="javascript:;" class="">
                  ...
                  <ul class="sub">
                      <li><a class="" href="View/Admin/postHome.php">Post to Home</a></li>
                      <li><a class="" href="View/Admin/postNoticeBoard.php">Post to Notice Board</a></li>
                  </ul>
          </li>
          <li class="sub-menu">
              <a href="javascript:;" class="">
                  ...
                  <ul class="sub">
                      <li><a class="" href="View/Admin/viewCommonPost.php">View common post</a></li>
                      <li><a class="" href="View/Admin/viewNoticeBoard.php">View Notice Board</a></li>
                  </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;" class="">
            ...
            <ul class="sub">
                <li><a class="" href="View/Admin/helpDesk.php">Help Desk</a></li>
                <li><a class="" href="View/Admin/complain.php">Complain</a></li>
            </ul>
          </li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
                <li><a class="" href="View/Admin/Rating_timing.php">Timing</a></li>
                <li><a class="" href="View/Admin/Rating_Quality.php"><span>Quality</span></a></li>
                <li><a class="" href="View/Admin/Rating_Ethic.php"><span>Ethic</span></a></li>
            </ul>
          </li>
